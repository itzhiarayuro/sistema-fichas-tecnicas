        ...
        if (isShape) {
            ...
            return (
                ...
                >
                    ...
                    <div className="flex-grow w-full flex items-center justify-center overflow-hidden bg-gray-50/50 rounded"
                        style={{
                    ...
                    >
                        {placement.fieldId.startsWith('foto_') ? (
                            <div className="flex flex-col items-center justify-center text-gray-400 gap-1">
                                ...
                                <span className="text-[7px] uppercase font-bold tracking-tighter opacity-50">
                                    {placement.fieldId.replace('foto_', '').replace('_', ' ')}
                                </span>
                            </div>
                        ) : (
