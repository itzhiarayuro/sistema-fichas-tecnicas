...
export type FieldCategory = 'pozo' | 'tuberias' | 'entradas' | 'salidas' | 'sumideros' | 'fotos' | 'otros';
...
export const AVAILABLE_FIELDS: AvailableField[] = [
    ...
    { id: 'tub_1_z', label: 'Tub 1 Prof. clave (m)', fieldPath: 'tuberias.tuberias[0].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_1_emboquillado', label: 'Tub 1 Emboquillado', fieldPath: 'tuberias.tuberias[0].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_2_z', label: 'Tub 2 Prof. clave (m)', fieldPath: 'tuberias.tuberias[1].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_2_emboquillado', label: 'Tub 2 Emboquillado', fieldPath: 'tuberias.tuberias[1].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_3_estado', label: 'Tub 3 Est', fieldPath: 'tuberias.tuberias[2].estado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    ...
    { id: 'tub_3_z', label: 'Tub 3 Prof. clave (m)', fieldPath: 'tuberias.tuberias[2].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_3_emboquillado', label: 'Tub 3 Emboquillado', fieldPath: 'tuberias.tuberias[2].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_4_estado', label: 'Tub 4 Est', fieldPath: 'tuberias.tuberias[3].estado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    ...
    { id: 'tub_4_z', label: 'Tub 4 Prof. clave (m)', fieldPath: 'tuberias.tuberias[3].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_4_emboquillado', label: 'Tub 4 Emboquillado', fieldPath: 'tuberias.tuberias[3].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_5_z', label: 'Tub 5 Prof. clave (m)', fieldPath: 'tuberias.tuberias[4].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_5_emboquillado', label: 'Tub 5 Emboquillado', fieldPath: 'tuberias.tuberias[4].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_6_z', label: 'Tub 6 Prof. clave (m)', fieldPath: 'tuberias.tuberias[5].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_6_emboquillado', label: 'Tub 6 Emboquillado', fieldPath: 'tuberias.tuberias[5].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_7_z', label: 'Tub 7 Prof. clave (m)', fieldPath: 'tuberias.tuberias[6].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_7_emboquillado', label: 'Tub 7 Emboquillado', fieldPath: 'tuberias.tuberias[6].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    ...
    { id: 'tub_8_z', label: 'Tub 8 Prof. clave (m)', fieldPath: 'tuberias.tuberias[7].cota.value', category: 'tuberias', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'tub_8_emboquillado', label: 'Tub 8 Emboquillado', fieldPath: 'tuberias.tuberias[7].emboquillado.value', category: 'tuberias', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    // ENTRADAS ESPECÍFICAS (E1-E6)
    { id: 'ent_1_id', label: 'Entrada 1 ID', fieldPath: 'dynamic.ent1.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_1_diametro', label: 'Entrada 1 Ø', fieldPath: 'dynamic.ent1.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_1_material', label: 'Entrada 1 Mat', fieldPath: 'dynamic.ent1.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_1_estado', label: 'Entrada 1 Est', fieldPath: 'dynamic.ent1.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_1_batea', label: 'Entrada 1 Bat', fieldPath: 'dynamic.ent1.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_1_z', label: 'Entrada 1 Prof. (m)', fieldPath: 'dynamic.ent1.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_1_emboquillado', label: 'Entrada 1 Emb.', fieldPath: 'dynamic.ent1.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'ent_2_id', label: 'Entrada 2 ID', fieldPath: 'dynamic.ent2.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_2_diametro', label: 'Entrada 2 Ø', fieldPath: 'dynamic.ent2.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_2_material', label: 'Entrada 2 Mat', fieldPath: 'dynamic.ent2.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_2_estado', label: 'Entrada 2 Est', fieldPath: 'dynamic.ent2.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_2_batea', label: 'Entrada 2 Bat', fieldPath: 'dynamic.ent2.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_2_z', label: 'Entrada 2 Prof. (m)', fieldPath: 'dynamic.ent2.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_2_emboquillado', label: 'Entrada 2 Emb.', fieldPath: 'dynamic.ent2.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'ent_3_id', label: 'Entrada 3 ID', fieldPath: 'dynamic.ent3.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_3_diametro', label: 'Entrada 3 Ø', fieldPath: 'dynamic.ent3.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_3_material', label: 'Entrada 3 Mat', fieldPath: 'dynamic.ent3.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_3_estado', label: 'Entrada 3 Est', fieldPath: 'dynamic.ent3.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_3_batea', label: 'Entrada 3 Bat', fieldPath: 'dynamic.ent3.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_3_z', label: 'Entrada 3 Prof. (m)', fieldPath: 'dynamic.ent3.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_3_emboquillado', label: 'Entrada 3 Emb.', fieldPath: 'dynamic.ent3.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'ent_4_id', label: 'Entrada 4 ID', fieldPath: 'dynamic.ent4.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_4_diametro', label: 'Entrada 4 Ø', fieldPath: 'dynamic.ent4.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_4_material', label: 'Entrada 4 Mat', fieldPath: 'dynamic.ent4.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_4_estado', label: 'Entrada 4 Est', fieldPath: 'dynamic.ent4.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_4_batea', label: 'Entrada 4 Bat', fieldPath: 'dynamic.ent4.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_4_z', label: 'Entrada 4 Prof. (m)', fieldPath: 'dynamic.ent4.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_4_emboquillado', label: 'Entrada 4 Emb.', fieldPath: 'dynamic.ent4.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'ent_5_id', label: 'Entrada 5 ID', fieldPath: 'dynamic.ent5.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_5_diametro', label: 'Entrada 5 Ø', fieldPath: 'dynamic.ent5.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_5_material', label: 'Entrada 5 Mat', fieldPath: 'dynamic.ent5.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_5_estado', label: 'Entrada 5 Est', fieldPath: 'dynamic.ent5.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_5_batea', label: 'Entrada 5 Bat', fieldPath: 'dynamic.ent5.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_5_z', label: 'Entrada 5 Prof. (m)', fieldPath: 'dynamic.ent5.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_5_emboquillado', label: 'Entrada 5 Emb.', fieldPath: 'dynamic.ent5.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'ent_6_id', label: 'Entrada 6 ID', fieldPath: 'dynamic.ent6.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_6_diametro', label: 'Entrada 6 Ø', fieldPath: 'dynamic.ent6.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_6_material', label: 'Entrada 6 Mat', fieldPath: 'dynamic.ent6.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_6_estado', label: 'Entrada 6 Est', fieldPath: 'dynamic.ent6.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_6_batea', label: 'Entrada 6 Bat', fieldPath: 'dynamic.ent6.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_6_z', label: 'Entrada 6 Prof. (m)', fieldPath: 'dynamic.ent6.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_6_emboquillado', label: 'Entrada 6 Emb.', fieldPath: 'dynamic.ent6.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'ent_7_id', label: 'Entrada 7 ID', fieldPath: 'dynamic.ent7.id', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'ent_7_diametro', label: 'Entrada 7 Ø', fieldPath: 'dynamic.ent7.diametro', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_7_material', label: 'Entrada 7 Mat', fieldPath: 'dynamic.ent7.material', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_7_estado', label: 'Entrada 7 Est', fieldPath: 'dynamic.ent7.estado', category: 'entradas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'ent_7_batea', label: 'Entrada 7 Bat', fieldPath: 'dynamic.ent7.batea', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_7_z', label: 'Entrada 7 Prof. (m)', fieldPath: 'dynamic.ent7.z', category: 'entradas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'ent_7_emboquillado', label: 'Entrada 7 Emb.', fieldPath: 'dynamic.ent7.emboquillado', category: 'entradas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    // SALIDAS ESPECÍFICAS (S1-S6)
    { id: 'sal_1_id', label: 'Salida 1 ID', fieldPath: 'dynamic.sal1.id', category: 'salidas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'sal_1_diametro', label: 'Salida 1 Ø', fieldPath: 'dynamic.sal1.diametro', category: 'salidas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'sal_1_material', label: 'Salida 1 Mat', fieldPath: 'dynamic.sal1.material', category: 'salidas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'sal_1_estado', label: 'Salida 1 Est', fieldPath: 'dynamic.sal1.estado', category: 'salidas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'sal_1_batea', label: 'Salida 1 Bat', fieldPath: 'dynamic.sal1.batea', category: 'salidas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'sal_1_z', label: 'Salida 1 Prof. (m)', fieldPath: 'dynamic.sal1.z', category: 'salidas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'sal_1_emboquillado', label: 'Salida 1 Emb.', fieldPath: 'dynamic.sal1.emboquillado', category: 'salidas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },

    { id: 'sal_2_id', label: 'Salida 2 ID', fieldPath: 'dynamic.sal2.id', category: 'salidas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
    { id: 'sal_2_diametro', label: 'Salida 2 Ø', fieldPath: 'dynamic.sal2.diametro', category: 'salidas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'sal_2_material', label: 'Salida 2 Mat', fieldPath: 'dynamic.sal2.material', category: 'salidas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'sal_2_estado', label: 'Salida 2 Est', fieldPath: 'dynamic.sal2.estado', category: 'salidas', isRepeatable: true, defaultWidth: 45, defaultHeight: 10 },
    { id: 'sal_2_batea', label: 'Salida 2 Bat', fieldPath: 'dynamic.sal2.batea', category: 'salidas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'sal_2_z', label: 'Salida 2 Prof. (m)', fieldPath: 'dynamic.sal2.z', category: 'salidas', isRepeatable: true, defaultWidth: 35, defaultHeight: 10 },
    { id: 'sal_2_emboquillado', label: 'Salida 2 Emb.', fieldPath: 'dynamic.sal2.emboquillado', category: 'salidas', isRepeatable: true, defaultWidth: 40, defaultHeight: 10 },
