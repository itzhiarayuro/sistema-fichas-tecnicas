...
export const AVAILABLE_DATA_FIELDS = [
    ...
    { id: 'tub_1_z', label: 'Tub 1 Z', category: 'Tuberías' },
    { id: 'tub_1_emboquillado', label: 'Tub 1 Emboquillado', category: 'Tuberías' },
    { id: 'tub_2_z', label: 'Tub 2 Z', category: 'Tuberías' },
    { id: 'tub_2_emboquillado', label: 'Tub 2 Emboquillado', category: 'Tuberías' },
    { id: 'tub_3_z', label: 'Tub 3 Z', category: 'Tuberías' },
    { id: 'tub_3_emboquillado', label: 'Tub 3 Emboquillado', category: 'Tuberías' },
    { id: 'tub_4_z', label: 'Tub 4 Z', category: 'Tuberías' },
    { id: 'tub_4_emboquillado', label: 'Tub 4 Emboquillado', category: 'Tuberías' },
    { id: 'tub_5_z', label: 'Tub 5 Z', category: 'Tuberías' },
    { id: 'tub_5_emboquillado', label: 'Tub 5 Emboquillado', category: 'Tuberías' },
    { id: 'tub_6_z', label: 'Tub 6 Z', category: 'Tuberías' },
    { id: 'tub_6_emboquillado', label: 'Tub 6 Emboquillado', category: 'Tuberías' },
    { id: 'tub_7_z', label: 'Tub 7 Z', category: 'Tuberías' },
    { id: 'tub_7_emboquillado', label: 'Tub 7 Emboquillado', category: 'Tuberías' },
    { id: 'tub_8_z', label: 'Tub 8 Z', category: 'Tuberías' },
    { id: 'tub_8_emboquillado', label: 'Tub 8 Emboquillado', category: 'Tuberías' },
